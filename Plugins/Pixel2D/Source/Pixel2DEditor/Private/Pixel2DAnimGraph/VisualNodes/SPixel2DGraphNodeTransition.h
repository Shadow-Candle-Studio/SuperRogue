...
class SPixel2DGraphNodeTransition : public SGraphNode
{
public:
	SLATE_BEGIN_ARGS(SPixel2DGraphNodeTransition) {}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs, UPixel2DAnimStateTransitionNode* InNode);
	...
	static FLinearColor StaticGetTransitionColor(UPixel2DAnimStateTransitionNode* TransNode, bool bIsHovered);
private:
