...
#include "ULevelSequenceEditorSettings_SKA.generated.h"

USTRUCT()
struct FLevelSequencePropertyTrackSettings_SKA
{
	GENERATED_BODY()
...
USTRUCT()
struct FLevelSequenceTrackSettings_SKA
{
	GENERATED_BODY()
	...
	TArray<FLevelSequencePropertyTrackSettings_SKA> DefaultPropertyTracks;

	/** List of property names for which movie scene tracks will not be created automatically. */
	UPROPERTY(config, EditAnywhere, Category=TrackSettings)
	TArray<FLevelSequencePropertyTrackSettings_SKA> ExcludeDefaultPropertyTracks;
};
...
class ULevelSequenceEditorSettings_SKA
	: public UObject
{
	GENERATED_BODY()
...
public:
	...
	ULevelSequenceEditorSettings_SKA(const FObjectInitializer& ObjectInitializer);
	...
	TArray<FLevelSequenceTrackSettings_SKA> TrackSettings;
 ...
 */
UCLASS(config=EditorPerProjectUserSettings)
class ULevelSequenceMasterSequenceSettings_SKA
	: public UObject
{
