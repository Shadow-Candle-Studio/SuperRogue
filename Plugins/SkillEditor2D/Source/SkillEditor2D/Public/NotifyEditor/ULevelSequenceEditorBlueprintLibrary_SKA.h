...
#include "ULevelSequenceEditorBlueprintLibrary_SKA.generated.h"
...
struct FSequencerChannelProxy_SKA
{
	GENERATED_BODY()

	FSequencerChannelProxy_SKA()
		: Section(nullptr)
	{}

	FSequencerChannelProxy_SKA(const FName& InChannelName, UMovieSceneSection* InSection)
...
UCLASS()
class SKILLEDITOR2D_API ULevelSequenceEditorBlueprintLibrary_SKA : public UBlueprintFunctionLibrary
{
public:
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Level Sequence Editor")
	static TArray<FSequencerChannelProxy_SKA> GetSelectedChannels();
	...
	/** Select channels */
	UFUNCTION(BlueprintCallable, Category = "Level Sequence Editor")
	static void SelectChannels(const TArray<FSequencerChannelProxy_SKA>& Channels);
