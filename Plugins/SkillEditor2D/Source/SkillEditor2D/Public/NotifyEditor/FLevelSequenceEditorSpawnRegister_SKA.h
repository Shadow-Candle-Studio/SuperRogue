 ...
 */
class SKILLEDITOR2D_API FLevelSequenceEditorSpawnRegister_SKA
	: public FLevelSequenceSpawnRegister
{
public:

	/** Constructor */
	FLevelSequenceEditorSpawnRegister_SKA();
...
private:
	...
	struct FTrackedObjectState_SKA
	{
		FTrackedObjectState_SKA(FMovieSceneSequenceIDRef InTemplateID, const FGuid& InObjectBindingID) : TemplateID(InTemplateID), ObjectBindingID(InObjectBindingID), bHasBeenModified(false) {}
...
private:
	...
	TMap<FObjectKey, FTrackedObjectState_SKA> TrackedObjects;
