 ...
 */
class FLevelSequenceEditorStyle_SKA
	: public FSlateStyleSet
{
public:

	/** Default constructor. */
	 FLevelSequenceEditorStyle_SKA()
	 ...
	 /** Virtual destructor. */
	 virtual ~FLevelSequenceEditorStyle_SKA()
	 {
		FSlateStyleRegistry::UnRegisterSlateStyle(*this);
	 }

	static TSharedRef<FLevelSequenceEditorStyle_SKA> Get()
	{
		if (!Singleton.IsValid())
		{
			Singleton = MakeShareable(new FLevelSequenceEditorStyle_SKA);
		}
		return Singleton.ToSharedRef();
	}

private:
	static TSharedPtr<FLevelSequenceEditorStyle_SKA> Singleton;
};
TSharedPtr<FLevelSequenceEditorStyle_SKA> FLevelSequenceEditorStyle_SKA::Singleton=nullptr;
