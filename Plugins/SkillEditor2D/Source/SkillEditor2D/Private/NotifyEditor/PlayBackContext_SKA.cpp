...
#include "NotifyEditor/PlayBackContext_SKA.h"
...
private:
	...
	{
		ULevelSequenceEditorSettings_SKA* Settings = GetMutableDefault<ULevelSequenceEditorSettings_SKA>();
	...
	{
		return GetDefault<ULevelSequenceEditorSettings_SKA>()->bAutoBindToPIE;
	}
	...
	{
		return GetDefault<ULevelSequenceEditorSettings_SKA>()->bAutoBindToSimulate;
	}
...
FLevelSequencePlaybackContext_SKA::FLevelSequencePlaybackContext_SKA()
{
	FEditorDelegates::MapChange.AddRaw(this, &FLevelSequencePlaybackContext_SKA::OnMapChange);
	FEditorDelegates::PreBeginPIE.AddRaw(this, &FLevelSequencePlaybackContext_SKA::OnPieEvent);
	FEditorDelegates::BeginPIE.AddRaw(this, &FLevelSequencePlaybackContext_SKA::OnPieEvent);
	FEditorDelegates::PostPIEStarted.AddRaw(this, &FLevelSequencePlaybackContext_SKA::OnPieEvent);
	FEditorDelegates::PrePIEEnded.AddRaw(this, &FLevelSequencePlaybackContext_SKA::OnPieEvent);
	FEditorDelegates::EndPIE.AddRaw(this, &FLevelSequencePlaybackContext_SKA::OnPieEvent);
}
...
void FLevelSequencePlaybackContext_SKA::OnPieEvent(bool)
{
	WeakCurrentContext = nullptr;
}

void FLevelSequencePlaybackContext_SKA::OnMapChange(uint32)
{
	WeakCurrentContext = nullptr;
}

UWorld* FLevelSequencePlaybackContext_SKA::Get() const
{
...
UObject* FLevelSequencePlaybackContext_SKA::GetAsObject() const
{
	return Get();
}

TArray<UObject*> FLevelSequencePlaybackContext_SKA::GetEventContexts() const
{
...
void FLevelSequencePlaybackContext_SKA::OverrideWith(UWorld* InNewContext)
{
	// InNewContext may be null to force an auto update
	WeakCurrentContext = InNewContext;
}

TSharedRef<SWidget> FLevelSequencePlaybackContext_SKA::BuildWorldPickerCombo()
{
	return SNew(SLevelSequenceContextPicker)
		.Value(this, &FLevelSequencePlaybackContext_SKA::Get)
		.OnSetValue(this, &FLevelSequencePlaybackContext_SKA::OverrideWith);
}

UWorld* FLevelSequencePlaybackContext_SKA::ComputePlaybackContext()
{
	const ULevelSequenceEditorSettings_SKA* Settings            = GetDefault<ULevelSequenceEditorSettings_SKA>();
