...
TSharedRef<IMovieSceneObjectSpawner> FLevelSequenceEditorActorSpawner_SKA::CreateObjectSpawner()
{
	return MakeShareable(new FLevelSequenceEditorActorSpawner_SKA);
}

#if WITH_EDITOR

TValueOrError<FNewSpawnable, FText> FLevelSequenceEditorActorSpawner_SKA::CreateNewSpawnableType(UObject& SourceObject, UMovieScene& OwnerMovieScene, UActorFactory* ActorFactory)
{
...
bool FLevelSequenceEditorActorSpawner_SKA::CanSetupDefaultsForSpawnable(UObject* SpawnedObject) const
{
...
void FLevelSequenceEditorActorSpawner_SKA::SetupDefaultsForSpawnable(UObject* SpawnedObject, const FGuid& Guid, const TOptional<FTransformData>& TransformData, TSharedRef<ISequencer> Sequencer, USequencerSettings* Settings)
{
