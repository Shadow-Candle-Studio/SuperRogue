...
class SMasterSequenceSettings_SKA : public SCompoundWidget, public FGCObject
{
	SLATE_BEGIN_ARGS(SMasterSequenceSettings_SKA) {}
		SLATE_ARGUMENT(ULevelSequenceMasterSequenceSettings_SKA*, MasterSequenceSettings)
		SLATE_ARGUMENT(UMovieSceneToolsProjectSettings*, ToolsProjectSettings)
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs)
	{
		const ULevelSequenceMasterSequenceSettings_SKA* LevelSequenceSettings = GetDefault<ULevelSequenceMasterSequenceSettings_SKA>();
		...
		[
			...
			[
				SNew(STextBlock)
				.Text(this, &SMasterSequenceSettings_SKA::GetMasterSequenceFullPath)
			]
			...
			[
				...
				.Text(this, &SMasterSequenceSettings_SKA::GetErrorText)
			...
			[
				...
				.OnClicked(this, &SMasterSequenceSettings_SKA::OnCreateMasterSequence)
			]
		];
	...
	void SetMasterSequenceSettings(ULevelSequenceMasterSequenceSettings_SKA* InMasterSequenceSettings)
	{
...
private:
	...
	FReply OnCreateMasterSequence()
	{
		...
		UObject* MasterSequenceAsset = LevelSequenceEditorHelpers_SKA::CreateLevelSequenceAsset(MasterSequenceAssetName, MasterSequencePackagePath);
	...
	ULevelSequenceMasterSequenceSettings_SKA* MasterSequenceSettings;
	UMovieSceneToolsProjectSettings* ToolsProjectSettings;
};
	

void LevelSequenceEditorHelpers_SKA::OpenMasterSequenceDialog(const TSharedRef<FTabManager>& TabManager)
{
	...
	ULevelSequenceMasterSequenceSettings_SKA* MasterSequenceSettings = GetMutableDefault<ULevelSequenceMasterSequenceSettings_SKA>();
	...
	ExistingWindow->SetContent(
		SNew(SMasterSequenceSettings_SKA)
...
UObject* LevelSequenceEditorHelpers_SKA::CreateLevelSequenceAsset(const FString& AssetName, const FString& PackagePath, UObject* AssetToDuplicate)
{
